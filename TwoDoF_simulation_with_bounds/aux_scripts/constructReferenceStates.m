...
%
    if isempty(q1) & isempty(q2)
        b1 = pi/15;
        b2 = pi/15;
        q1 = -pi/2+65*pi/180*sin(b1*t_span);
        q2 = 3/4*pi*sin(b2*t_span);
    end
...
%     q2_fourth_deriv  = zeros(size(t_span));
    ...
    q1_first_deriv     = 65*pi/180*b1*cos(b1*t_span);
    q1_second_deriv    = -65*pi/180*b1^2*sin(b1*t_span);
    q1_third_deriv     = -65*pi/180*b1^3*cos(b1*t_span);
    q1_fourth_deriv    = 65*pi/180*b1^4*sin(b1*t_span);
      
    q2_first_deriv     = 3/4*pi*b2*cos(b2*t_span);
    q2_second_deriv    = -3/4*pi*b2^2*sin(b2*t_span);
    q2_third_deriv     = -3/4*pi*b2^3*cos(b2*t_span);
    q2_fourth_deriv    = 3/4*pi*b2^4*sin(b2*t_span);
